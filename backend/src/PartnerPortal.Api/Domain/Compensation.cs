...
public sealed record Invoice(Guid Id, Guid PartnerId, string Reference, string DocumentType, DateTime IssueDate, DateTime DueDate, decimal TotalAmount, decimal Perception, decimal PendingAmount, string Status);
