...
export type CompensationInvoice = { id: string; reference: string; documentType: string; issueDate: string; dueDate: string; totalAmount: number; perception: number; pendingAmount: number; status: string; isOverdue: boolean };
